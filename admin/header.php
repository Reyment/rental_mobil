...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark p-3" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'laporan'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/laporan.php">Laporan</a>
                </li>
            </ul>
